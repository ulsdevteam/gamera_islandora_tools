	...
	<xsl:template match="mods:relatedItem[mods:titleInfo | mods:name | mods:identifier | mods:location]">
		<xsl:choose>
			...
			<xsl:when test="@type='series'"/>
                        <!-- NOTE: this node was not being set by the original transformation, but this is populated for objects in the system
                             that have a mods:relatedItem with attribute type="host" -->
