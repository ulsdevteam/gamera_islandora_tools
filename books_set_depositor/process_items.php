...
//
// --->  include_once('/usr/local/src/islandora_tools/books_set_depositor/process_items.php');
//

// This is the logfile for this
define('LOGFILE', dirname(__FILE__).'/logfile');
define('TRANSFORM_STYLESHEET', dirname(__FILE__).'/xsl/update_depositor.xsl');
...
$csv_filename = dirname(__FILE__) . '/books_no_depositors.csv';
...
function process_change($islandora_object, $title) {
  ...
  echo $islandora_object->id . ' <a href="/islandora/object/' . $islandora_object->id . '/manage/datastreams">' . $title . "</a><br>";
