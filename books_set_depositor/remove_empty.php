...
//
// --->  include_once('/usr/local/src/islandora_tools/books_set_depositor/remove_empty.php');
//

// This is the logfile for this
define('LOGFILE', dirname(__FILE__).'/logfile');
define('TRANSFORM_STYLESHEET', dirname(__FILE__).'/xsl/remove_empty_depositor.xsl');
...
$csv_filename = dirname(__FILE__) . '/books_init.csv';
